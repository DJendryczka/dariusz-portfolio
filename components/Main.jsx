    ...
    <div className=" ">
      <section className=" w-full h-screen text-center ">
        <div className=" max-w-[1240px] w-full h-full mx-auto  flex justify-center items-center flex-col">
          ...
          <div className=" relative  shadow-gray-400 bg-gradient-to-b from-orange-600 rounded-full w-40 h-40 my-10 mx-auto overflow-hidden md:h-64 md:w-64 shadow-2xl">
            <Image
              src={Darek}
              alt="Pic of me"
              layout="fill"
